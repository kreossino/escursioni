...
class escursioni_ui extends e_admin_ui
{
        ...
        protected $prefs = array(
            ...
            'escursioni_menu_global_limit' => array('title'=> 'Numero record nel Blocco Menu', 'tab'=>0, 'type'=>'number', 'data' => 'int', 'help'=>'Indica quante escursioni mostrare al massimo nel widget laterale prima dello scroll'),
        );        
