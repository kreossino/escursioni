...
// Carica le definizioni di lingua per l'area admin
e107::lan('escursioni', 'admin');

/**
* Class PLUGIN_library.
*/
class escursioni_library
{
/**
...
function config()
{
    ...
    $libraries['example'] = array(
        ...
        'name'              => $LAN['escursioni_lib_example_name'], // Localizzato
    ...
    $libraries['simple'] = array(
        'name'              => $LAN['escursioni_lib_simple_name'], // Localizzato
    ...
    $libraries['tinymce'] = array(
        'name'              => 'TinyMCE', // Nome ufficiale vendor (non tradotto)
    ...
    $libraries['facebook-php-sdk-v4'] = array(
        'name'              => 'Facebook PHP SDK v4', // Nome ufficiale vendor
    ...
    $libraries['facebook-php-sdk-v5'] = array(
        'name'              => 'Facebook PHP SDK v5', // Nome ufficiale vendor
        'vendor_url'        => 'https://github.com/facebook/facebook-php-sdk-v4',
